...
const DATA = {
  ...
  'team-it-after': {
    ...
    lowScores: [
      { q: 'I know what results are expected of me at work', s: 68 },
      { q: 'Doing my work gives me energy', s: 70 },
      { q: 'I am provided with good work resources', s: 71 },
      { q: 'My skills and abilities fit in well with my job', s: 72 },
      { q: 'I enjoy doing my work / tasks', s: 73 }
    ],
  ...
  'novanta-after': {
    ...
    lowScores: [
      { q: 'I know what results are expected of me at work', s: 66 },
      { q: 'Doing my work gives me energy', s: 68 },
      { q: 'I am provided with good work resources', s: 69 },
      { q: 'My skills and abilities fit in well with my job', s: 70 },
      { q: 'I enjoy doing my work / tasks', s: 71 }
    ],
  ...
  'novanta-before': {
    ...
    lowScores: [
      { q: 'I know what results are expected of me at work', s: 58 },
      { q: 'Doing my work gives me energy', s: 61 },
      { q: 'I am provided with good work resources', s: 63 },
      { q: 'My skills and abilities fit in well with my job', s: 64 },
      { q: 'I enjoy doing my work / tasks', s: 66 }
    ],
