...
function shell(d) {
  ...
  const efpMarker = (m) => `<div class="efp-marker ${m.variant}" style="left:${m.x}%;top:${100 - m.y}%"><div class="efp-dot"></div><div class="efp-chip"><i data-icon="${m.icon}"></i>${m.label}</div></div>`;
